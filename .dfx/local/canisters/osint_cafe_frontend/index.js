...
import { idlFactory } from './osint_cafe_frontend.did.js';
export { idlFactory } from './osint_cafe_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_OSINT_CAFE_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./osint_cafe_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the osint_cafe_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./osint_cafe_frontend.did.js")._SERVICE>}
 */
export const osint_cafe_frontend = createActor(canisterId);
