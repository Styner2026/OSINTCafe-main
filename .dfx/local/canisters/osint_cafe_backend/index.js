...
import { idlFactory } from './osint_cafe_backend.did.js';
export { idlFactory } from './osint_cafe_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_OSINT_CAFE_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./osint_cafe_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the osint_cafe_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./osint_cafe_backend.did.js")._SERVICE>}
 */
export const osint_cafe_backend = createActor(canisterId);
